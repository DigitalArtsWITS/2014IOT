/* From Learning Processing by Daniel Shiffman
 ...
 This focuses on a writing a function that returns a value of how far the mouse if from the other rectanlges
 Look at how fill uses distance and how the input values change all the time, but are assingned into the local variables.
 */
...
void draw() {
  ...
  println(distance(0,0,mouseX,mouseY));
